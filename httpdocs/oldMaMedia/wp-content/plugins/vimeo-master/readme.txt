...
Another outstanding plugin for wordpress. Vimeo Master let's you integrate the superb Vimeo Video Sharing Network into any wordpress website.
...
* [Advanced Version Link](https://wordpress.techgasp.com/vimeo-master/)

**ONLINE DEMO**

* Right of the page, sidebar widget
* Inside the post. With shortcode framework v5
* [Demo Link](https://wordpress.techgasp.com/vimeo-master/)
...
3. Visit the "Widget Page | Vimeo Master Widgets" to configure widget settings and your template widget positions
4. [Vimeo Master Documentation](https://wordpress.techgasp.com/vimeo-master-documentation)
...
= Need More Help =
* [Vimeo Master Documentation](https://wordpress.techgasp.com/vimeo-master-documentation)
