						...
						'footer-scripts' => array
							(
								...
								'wpgrade-main-scripts' => array (
									...
									'cache_bust' => '20160615',
									'require' => array(
										'wpgrade-plugins', 'wpgrade-rs', 'wpgrade-mix', 'wpgrade-easing',
									),
								),
					...
					(
						...
						array
							(
								...
								'objectl10n' => array
									(
										'tPrev' => __('Previous (Left arrow key)', 'lens'),
										'tNext' => __('Next (Right arrow key)', 'lens'),
										'tCounter' => __('of', 'lens')
									),
							),
					),
...
//							),
		...
		'pagination' => array
			(
				...
				// pagination text
				'prev_text' => __('Newer posts', 'lens'),
				'next_text' => __('Older posts', 'lens'),
		...
		'pagination-targets' => array
			(
				...
				'gallery' => array
					(
						'formatter' => null,
						'prev_text' => __('Prev Images', 'lens'),
						'next_text' => __('Next Images', 'lens'),
					),
				'galleries' => array
				(
					'formatter' => 'wpgrade_callback_pagination_formatter',
					'prev_text' => __('Prev', 'lens'),
					'next_text' => __('Next', 'lens'),
				),
				'portfolio' => array
				(
					'formatter' => 'wpgrade_callback_pagination_formatter',
